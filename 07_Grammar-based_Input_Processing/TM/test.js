...
test.describe('Pemrosesan untuk brave.com', () => {
    const brave = fs.readFileSync(path.join(__dirname, 'daftar', 'brave.txt'), 'utf-8');
...
test.describe('Pemrosesan untuk mikrotik.com', () => {
    const mikrotik = fs.readFileSync(path.join(__dirname, 'daftar', 'mikrotik.txt'), 'utf-8');
...
test.describe('Pemrosesan untuk openai.com', () => {
    const openai = fs.readFileSync(path.join(__dirname, 'daftar', 'openai.txt'), 'utf-8');
...
test.describe('Pemrosesan untuk lazada.com', () => {
    const lazada = fs.readFileSync(path.join(__dirname, 'daftar', 'lazada.txt'), 'utf-8');
...
test.describe('Pemrosesan untuk kemenag.go.id', () => {
    const kemenag = fs.readFileSync(path.join(__dirname, 'daftar', 'kemenag.txt'), 'utf-8');
